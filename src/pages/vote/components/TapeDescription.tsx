import { Avatar, Box, Badge, Container, Divider, Flex, HStack, Stack, Square, Text } from '@chakra-ui/react';
      ...
      <Flex w="100%" flexDirection={{ base: 'column', md: 'row' }} justifyContent="space-evenly">
        ...
        >
          ...
          <Text fontSize="xs" color="muted" pt="2">
            The community votes on their favorite submissions. Voting power is determined from hedsTAPE(s) ownership. hedsTAPE(s) with a higher ratio of owners
            to tapes minted in the specific collection will have a higher voting power.
          </Text>
        </Box>
      </Flex>
    </Box>
