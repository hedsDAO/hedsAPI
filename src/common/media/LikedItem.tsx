...
export const LikedItem = ({ image, name }: { image: string; name: string }) => {
  const [hasImageLoaded, setHasImageLoaded] = useBoolean();
  return (
    <Box data-testid='liked-item'  border="solid 1px" borderColor="heds.100" rounded={'md'} px={3} pt={3} pb={2} bg="heds.bg2">
      <AspectRatio ratio={1}>
