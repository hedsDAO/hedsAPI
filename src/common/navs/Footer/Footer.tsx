const Footer = () => {
  return (
    <footer className="py-3 bg-[#f5f5f5] rounded-lg md:flex items-center md:justify-between md:py-5 dark:bg-gray-800">
      <div className="mx-auto max-w-7xl flex md:justify-between w-full">
