...
export const GENERATE_TWEET_DESCRIPTION = 'Generate a unique tweet to help us connect your twitter to our database';
...
export const COPY_TWEET_DESCRIPTION = 'Generate a unique tweet to help us connect your twitter to our database';
export const COPY_TWEET_BUTTON_TEXT = 'COPY';
export const COPY_TWEET_NEXT_BUTTON_TEXT = 'NEXT';

//  3. VERIFY_TWEET
export const VERIFY_TWEET_HEADING = 'Visit Twitter and tweet the copied message';
...
export const CONFIRM_DESCRIPTION = 'Are you sure you want to link your twitter? Once linked your profile cannot be unlinked';
