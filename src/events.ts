...
export const clickLinkToArtistFromMostAppearancesCard = () =>
  ReactGA.event({ category: 'Explore Page', action: 'Click Link To Artist From Most Appearances Card' });
export const clickLinkToTapeFromMostAppearancesCard = () =>
  ReactGA.event({ category: 'Explore Page', action: 'Click Link To Tape From Most Appearances Card' });
...
// Vote Page
export const clickViewVoteFromHeaderCarousel = (tape: string) =>
  ReactGA.event({ category: 'Vote Page', action: 'Click View Vote From Header Carousel', label: tape });
export const clickVoteCardFromVoteLanding = (tape: string) =>
  ReactGA.event({ category: 'Vote Page', action: 'Click Vote Card From Vote Landing', label: tape });
...
export const clickLinkToOpenseaNextToMintButton = (tape: string) =>
  ReactGA.event({ category: 'Tape Page', action: 'Click Link To Opensea - Button in Tape Timeline', label: tape });
...
export const clickDownloadSampleButtonInModal = (tape: string) =>
  ReactGA.event({ category: 'Tape Page', action: 'Click Download Sample Button In Modal', label: tape });
