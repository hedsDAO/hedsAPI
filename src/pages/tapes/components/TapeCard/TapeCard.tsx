...
export const TapeCard = ({ tape }: { tape: Tape }) => {
  ...
  return (
    <GridItem colSpan={1} key={tape.id + 'tapes'} _hover={{ cursor: 'pointer' }}>
      <Stack border="solid 0.5px" borderColor="heds.100" p={2} rounded="lg" bg="heds.bg4" onClick={() => navigate(`/tape/${tape.id}`)}>
        <AspectRatio ratio={1}>
